...
type Backend[
	...
	BlobSidecarsT BlobSidecars[any, BlobSidecarT],
...
func New[
	...
	BeaconStateT, BeaconStateMarshallableT, BlobSidecarT, BlobSidecarsT, BlockStoreT,
...
func (b *Backend[
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, NodeT, _, _, _, _, _, _,
...
func (b *Backend[
	_, _, _, _, BeaconStateT, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _,
